...
function SignUp() {
  const { setDisplayName } = useGlobalContext();
  ...
  return (
    ...
    gap-16 py-12 pt-6 px-20'
    >
      <section className='w-1/2'>
        <img
          src={loginImg2}
          className='brightness-90 h-full'
      ...
      <section className='flex flex-col gap-4 p-8 w-1/2 border-primary border rounded-sm'>
        ...
        <div className='w-full flex gap-4'>
          <button
            type='button'
            className='border border-primary px-10 py-2 rounded w-1/2 grid place-items-center hover:outline outline-1'
          >
            <svg className='size-8' viewBox='0 0 1152 1152'>
              <path
        ...
        <form className='flex flex-col gap-4 mt-3 my-4' onSubmit={handleSubmit}>
