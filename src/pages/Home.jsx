        ...
        <main>
          ...
          <section className='mt-12 flex flex-col px-6 lg:mt-24 lg:px-32'>
            <div className='mb-8 flex items-center justify-between'>
              ...
              <Link
                to={"/blog"}
                className='border-2 border-gray-500 px-6 py-2 text-xs font-semibold text-gray-600 hover:text-primary dark:border-darkSecondary dark:text-darkSecondary lg:px-10 lg:text-sm'
              >
                SEE ALL
              </Link>
            </div>
            ...
            <Link
              to={"/blog"}
              className='mx-auto mb-8 mt-20 grid w-fit place-items-center border-2 border-gray-500 px-5 py-3 text-[13px] font-semibold text-gray-500 hover:text-primary dark:border-darkSecondary dark:text-darkSecondary lg:px-9 lg:py-3.5 lg:text-[14px]'
            >
              LOAD MORE
            </Link>
          </section>
